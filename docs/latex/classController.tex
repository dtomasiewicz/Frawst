...
\end{DoxyReturn}
\hypertarget{classController_afd8b14fbfe9fe316fa4262fb56c80a9b}{
\index{Controller@{Controller}!offsetExists@{offsetExists}}
\index{offsetExists@{offsetExists}!Controller@{Controller}}
\subsubsection[{offsetExists}]{\setlength{\rightskip}{0pt plus 5cm}Controller::offsetExists (
\begin{DoxyParamCaption}
\item[{\$}]{ offset}
\end{DoxyParamCaption}
)}}
\label{classController_afd8b14fbfe9fe316fa4262fb56c80a9b}
The following methods are required for the ArrayAccess interface. They're used to allow storage of data for use by various methods in the controller. This data is for controller use only and will NOT be present in the \hyperlink{classResponse}{Response}. 
