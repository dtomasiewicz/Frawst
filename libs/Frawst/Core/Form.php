<?php
	...
	class Form implements \ArrayAccess {
		...
		public static function className($module, $name) {
			return 'Frawst\\'.$module.'\Form\\'.str_replace('/', '\\', $name);
		}
		
		public static function factory($module, $name = null, $data = array(), $checkToken = true) {
			$c = $name === null
				? get_called_class()
				: self::className($module, $name);
