<?php
	 ...
	 */
	class Inflector {
		private static $__camelBack = array();
		private static $__underscore = array();
		...
		public static function underscore($string) {
			if(!isset(self::$__underscore[$string])) {
				$str = lcfirst($string);
				...
				self::$__underscore[$string] = $str;
			}
			
			return self::$__underscore[$string];
		}
